...
const char kWebCommands[] PROGMEM =
  ...
  D_CMND_EMULATION "|"
#endif
  D_CMND_WEBSERVER "|" D_CMND_WEBPASSWORD "|" D_CMND_USERPASSWORD "|" D_CMND_WEBLOG "|" D_CMND_WEBREFRESH "|" D_CMND_WEBSEND "|" D_CMND_WEBCOLOR  ;

void (* const WebCommand[])(void) PROGMEM = {
#ifdef USE_EMULATION
  &CmndEmulation,
#endif
  &CmndWebServer, &CmndWebPassword, &CmndUserPassword, &CmndWeblog, &CmndWebRefresh, &CmndWebSend, &CmndWebColor };
