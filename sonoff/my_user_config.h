...
#define COLOR_CONSOLE_TEXT          "#eeeeee"    // [WebColor6] Console text color - Black
...
// -- Location ------------------------------------
#define LATITUDE               49.400628         // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              8.629917          // [Longitude] Your location to be used with sunrise and sunset
...
#define ENERGY_RESOLUTION      4                 // [EnergyRes] Maximum number of decimals (0 - 5) showing energy usage in kWh
#define CALC_RESOLUTION        4                 // [CalcRes] Maximum number of decimals (0 - 7) used in commands ADD, SUB, MULT and SCALE
